...
task xcompile_arm64, "Cross compile arm64 binary using zig":
  exec "nim c --cpu:arm64 --cc:clang --clang.exe=\"./zigcc.sh\" --clang.linkerexe=\"./zigcc.sh\" --passC:\"-target aarch64-linux-musl\" --passL:\"-target aarch64-linux-musl\" -d:release -o:tpix_arm64 tpix.nim"